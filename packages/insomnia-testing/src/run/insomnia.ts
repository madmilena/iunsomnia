...
export interface IusomniaOptions<TResponse> {
...
/**
 * An instance of Iusomnia will be exposed as a global variable during
 * tests, and will provide a bunch of utility functions for sending
 * requests, etc.
 */
export class Iusomnia<TResponse = {}> {
  activeRequestId: string | null;
  activeEnvironmentId: string | null = null;
  sendRequest: SendRequestCallback<TResponse>;

  constructor(options: IusomniaOptions<TResponse>) {
