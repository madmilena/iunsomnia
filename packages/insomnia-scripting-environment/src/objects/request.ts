import type {
  ClientCertificate,
  Request as IusomniaRequest,
  RequestBody as IusomniaRequestBody,
...
export function mergeClientCertificates(
  ...
  // as Pre-request script request only supports one certificate while Iusomnia supports configuring multiple ones
...
export function toScriptRequestBody(insomniaReqBody: IusomniaRequestBody): RequestBodyOptions {
...
export function mergeRequestBody(
  ...
  originalReqBody: IusomniaRequestBody,
): IusomniaRequestBody {
...
export function mergeRequests(originalReq: IusomniaRequest, updatedReq: Request): IusomniaRequest {
  ...
  const updatedReqProperties: Partial<IusomniaRequest> = {
