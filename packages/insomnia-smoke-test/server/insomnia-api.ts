  ...
  members: [
    {
      ...
      name: 'wei.yao+2@iusomnia.local ',
      email: 'wei.yao+2@iusomnia.local',
      role_name: 'owner',
    ...
    },
    {
      ...
      name: 'wei.yao+3@iusomnia.local ',
      email: 'wei.yao+3@iusomnia.local',
      role_name: 'member',
...
const invites = {
  ...
  invitations: [
    ...
    },
    {
      ...
      invitee: {
        email: 'wei.yao+6@iusomnia.local',
      },
    ...
    },
    {
      ...
      invitee: {
        email: 'wei.yao+4@iusomnia.local',
      },
...
const getEmailsForInviteSearch = ({ invitesCount = 0, membersCount = 0, groupsCount = 0 }: EmailsList) => {
  ...
  for (let i = 0; i < groupsCount; i++) {
    emails.push({
      id: getRandomId(),
      picture: 'https://static.iusomnia.local/insomnia-coffee.png',
      type: 'group',
      name: getTeamName(),
    });
  }
