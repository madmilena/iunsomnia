...
describe('OAuth 1.0', () => {
  it('Does OAuth 1.0', async () => {
    const authentication = {
      ...
      callback: 'https://iusomnia.local/callback/',
      tokenKey: 'tokenKey',
    ...
    const header = await getAuthHeader(request, 'https://iusomnia.local/');
    expect(header).toEqual({
      name: 'Authorization',
      value: [
        'OAuth ' + 'oauth_callback="https%3A%2F%2Fiusomnia.local%2Fcallback%2F"',
        'oauth_consumer_key="consumerKey"',
        'oauth_nonce="nonce"',
        'oauth_signature="YrALLxX2SIufiYo8DyI7ssAd9hI%3D"',
  ...
  it('Does OAuth 1.0 with RSA-SHA1', async () => {
    ...
    expect(header).toEqual({
      ...
      value: [
        ...
        'oauth_consumer_key="consumerKey"',
        'oauth_nonce="nonce"',
        'oauth_signature="QE%2FhNmvGE4RQkaRmA4dyzR15%2BUaYPrvTXVv1mFbG99WJvYc%2BKDABcnpCTcrX0UxR4tHEtB85Q6%2FbBCW0pCDA2chxDWck9AIo5jDGuX5nfhIyUqPttpaOrkA2zYbjpqs87HiJnpynIooCrBOTxFZ0vBgeV3gH33F%2BDWMJyQhlOSE%3D"',
