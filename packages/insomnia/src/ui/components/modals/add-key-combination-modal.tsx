...
export const AddKeyCombinationModal = forwardRef<AddKeyCombinationModalHandle, ModalProps>((_, ref) => {
  ...
  return (
    <Modal ref={modalRef} className="shortcuts add-key-comb-modal">
      <ModalHeader>{t('settings.shortcuts.addKeyboardShortcut')}</ModalHeader>
      <ModalBody noScroll>
        <div className="pad-left pad-right pad-top pad-bottom-sm">
          <div className="form-control form-control--outlined">
            <label>
              {t('modals.pressDesiredKeyCombination')}
              <input
        ...
        <div className={duplicateMessageClasses}>{t('modals.duplicateKeyCombination')}</div>
      </ModalBody>
    </Modal>
  );
});
