...
export interface Settings {
  ...
  /** If true, Iusomnia won’t show a notification when new updates are available. Users can still check for updates in Preferences. */
  ...
  /** If true, Iusomnia will send anonymous data about features and plugins used. */
  ...
  /** User selected language for the interface */
  language: Language;
}
