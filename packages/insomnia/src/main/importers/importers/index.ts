...
export type { Iusomnia1Data } from './insomnia-1';
export type { Iusomnia2Data } from './insomnia-2';
export type { Iusomnia3Data } from './insomnia-3';
export type { Iusomnia4Data } from './insomnia-4';
