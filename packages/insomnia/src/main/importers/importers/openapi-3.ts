...
/**
 * Return Iusomnia folder / request group
 */
...
/**
 * Get Iusomnia environment variables for OpenAPI securitySchemes
 *
 * @returns Iusomnia environment variables containing security information
 */
