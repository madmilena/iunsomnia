...
import type { Iusomnia1Data } from './insomnia-1';

export const id = 'insomnia-2';
export const name = 'Iusomnia v2';
export const description = 'Iusomnia export format 2';

export interface Iusomnia2Data extends Omit<Iusomnia1Data, '__export_format'> {
  __export_format: 2;
  resources: ImportRequest[];
}

export const convert: Converter = rawData => {
  let data: Iusomnia2Data | null = null;

  try {
    data = JSON.parse(rawData) as Iusomnia2Data;
  } catch {
    return null;
  }
