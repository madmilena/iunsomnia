...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/vendor/tsub/tsub.js
var require_tsub = __commonJS({
  "../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/vendor/tsub/tsub.js"(exports, module) {
    "use strict";
    !(function(t, r) {
      ...
      return (function() {
        var t = { 2870: function(t2, r2, e2) {
          ...
          Object.defineProperty(r2, "__esModule", { value: true });
          var o = n(e2(2263)), s = n(e2(7843)), i = n(e2(5500)), u = e2(2341), a = e2(4966);
          function c(t3, r3) {
          ...
          var n = e2(4903);
          t2.exports = function(t3, r3) {
            return 1 === arguments.length ? n([0, 0], t3) : n(t3, r3);
          };
        }, 4903: function(t2, r2, e2) {
          "use strict";
          var n = e2(4773), o = e2(7382), s = e2(5782), i = new o(1), u = new n(i.buffer), a = s.HIGH, c = s.LOW;
          t2.exports = function(t3, r3) {
            return i[0] = r3, t3[0] = u[a], t3[1] = u[c], t3;
          };
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/routing-middleware/index.js
...
//# sourceMappingURL=routing-middleware-X24SNSZR.js.map
