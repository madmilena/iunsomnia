...
} from "./chunk-WV476AFX.js";
import {
  require_matchbrackets
} from "./chunk-SLSVZWBO.js";
import {
  require_dialog
} from "./chunk-VTNFV6BB.js";
import {
  require_codemirror
...
var require_vim = __commonJS({
  "../../node_modules/codemirror/keymap/vim.js"(exports, module) {
    (function(mod) {
      if (typeof exports == "object" && typeof module == "object")
        mod(require_codemirror(), require_searchcursor(), require_dialog(), require_matchbrackets());
      ...
      "use strict";
      function initVim$1(CodeMirror3) {
        ...
        function enterVimMode(cm) {
          ...
          CodeMirror3.signal(cm, "vim-mode-change", { mode: "normal" });
          cm.on("cursorActivity", onCursorActivity);
          maybeInitVimState(cm);
          CodeMirror3.on(cm.getInputField(), "paste", getOnPasteFn(cm));
        }
        function leaveVimMode(cm) {
          cm.setOption("disableInput", false);
          cm.off("cursorActivity", onCursorActivity);
          CodeMirror3.off(cm.getInputField(), "paste", getOnPasteFn(cm));
          cm.state.vim = null;
          if (highlightTimeout) clearTimeout(highlightTimeout);
        }
        function detachVimMap(cm, next) {
          if (this == CodeMirror3.keyMap.vim) {
            cm.options.$customCursor = null;
            CodeMirror3.rmClass(cm.getWrapperElement(), "cm-fat-cursor");
          }
        ...
        function attachVimMap(cm, prev) {
          if (this == CodeMirror3.keyMap.vim) {
            ...
            CodeMirror3.addClass(cm.getWrapperElement(), "cm-fat-cursor");
          }
          if (!prev || prev.attach != attachVimMap)
            enterVimMode(cm);
        }
        CodeMirror3.defineOption("vimMode", false, function(cm, val, prev) {
          if (val && cm.getOption("keyMap") != "vim")
            cm.setOption("keyMap", "vim");
          else if (!val && prev != CodeMirror3.Init && /^vim/.test(cm.getOption("keyMap")))
        ...
        function cmKey(key, cm) {
          ...
          if (typeof cmd == "function") {
            CodeMirror3.signal(cm, "vim-keypress", vimKey);
          }
          return cmd;
        }
        ...
        var numberRegex = /[\d]/;
        var wordCharTest = [CodeMirror3.isWordChar, function(ch) {
          return ch && !CodeMirror3.isWordChar(ch) && !/\s/.test(ch);
        ...
        function clearInputState(cm, reason) {
          ...
          CodeMirror3.signal(cm, "vim-command-done", reason);
        }
        ...
        var commandDispatcher = {
          ...
          processSearch: function(cm, vim, command) {
            ...
            function onPromptKeyUp(e, query2, close) {
              var keyName = CodeMirror3.keyName(e), up, offset;
            ...
            function onPromptKeyDown(e, query2, close) {
              var keyName = CodeMirror3.keyName(e);
          ...
          findAndSelectNextInclusive: function(cm, _head, motionArgs, vim, prevInputState) {
            ...
            if (vim.visualMode) {
              if (vim.visualLine || vim.visualBlock) {
                ...
                vim.visualBlock = false;
                CodeMirror3.signal(cm, "vim-mode-change", { mode: "visual", subMode: "" });
              }
            ...
            if (!vim.visualMode) {
              ...
              if (args.linewise) {
                if (!wasLastLine) {
                  ...
                  CodeMirror3.commands.newlineAndIndent(cm);
                }
        ...
        var actions = {
          ...
          toggleOverwrite: function(cm) {
            if (!cm.state.overwrite) {
              ...
              CodeMirror3.signal(cm, "vim-mode-change", { mode: "replace" });
            } else {
              cm.toggleOverwrite(false);
              cm.setOption("keyMap", "vim-insert");
              CodeMirror3.signal(cm, "vim-mode-change", { mode: "insert" });
            }
          },
          enterInsertMode: function(cm, actionArgs, vim) {
            ...
            if (!vimGlobalState.macroModeState.isPlaying) {
              ...
              CodeMirror3.on(cm.getInputField(), "keydown", onKeyEventTargetKeyDown);
            }
            if (vim.visualMode) {
              exitVisualMode(cm);
            }
          ...
          toggleVisualMode: function(cm, actionArgs, vim) {
            ...
            if (!vim.visualMode) {
              ...
              CodeMirror3.signal(cm, "vim-mode-change", { mode: "visual", subMode: vim.visualLine ? "linewise" : vim.visualBlock ? "blockwise" : "" });
              updateCmSelection(cm);
          ...
          reselectLastSelection: function(cm, _actionArgs, vim) {
            ...
            if (lastSelection) {
              ...
              updateMark(cm, vim, "<", cursorMin(anchor, head));
              updateMark(cm, vim, ">", cursorMax(anchor, head));
              CodeMirror3.signal(cm, "vim-mode-change", {
                mode: "visual",
          ...
          newLineAndEnterInsertMode: function(cm, actionArgs, vim) {
            ...
            if (insertAt.line === cm.firstLine() && !actionArgs.after) {
              ...
              var newlineFn = CodeMirror3.commands.newlineAndIndentContinueComment || CodeMirror3.commands.newlineAndIndent;
              newlineFn(cm);
            }
          ...
          undo: function(cm, actionArgs) {
            cm.operation(function() {
              repeatFn(cm, CodeMirror3.commands.undo, actionArgs.repeat)();
              cm.setCursor(cm.getCursor("anchor"));
            });
          },
          redo: function(cm, actionArgs) {
            repeatFn(cm, CodeMirror3.commands.redo, actionArgs.repeat)();
          },
          ...
          replace: function(cm, actionArgs, vim) {
            ...
            if (replaceWith == "\n") {
              ...
              (CodeMirror3.commands.newlineAndIndentContinueComment || CodeMirror3.commands.newlineAndIndent)(cm);
            } else {
        ...
        function exitVisualMode(cm, moveHead) {
          ...
          vim.visualLine = false;
          vim.visualBlock = false;
          if (!vim.insertMode) CodeMirror3.signal(cm, "vim-mode-change", { mode: "normal" });
        }
        ...
        function expandTagUnderCursor(cm, head, inclusive) {
          var cur = head;
          if (!CodeMirror3.findMatchingTag || !CodeMirror3.findEnclosingTag) {
            return { start: cur, end: cur };
          }
          var tags = CodeMirror3.findMatchingTag(cm, head) || CodeMirror3.findEnclosingTag(cm, head);
        ...
        function unescapeRegexReplace(str) {
          var stream = new CodeMirror3.StringStream(str);
          var output = [];
          while (!stream.eol()) {
        ...
        ExCommandDispatcher.prototype = {
          ...
          _processCommand: function(cm, input, opt_params) {
            ...
            var inputStream = new CodeMirror3.StringStream(input);
        ...
        var exCommands = {
          ...
          sort: function(cm, params) {
            ...
            function parseArgs() {
              if (params.argString) {
                var args = new CodeMirror3.StringStream(params.argString);
                if (args.eat("!")) {
                  reverse = true;
                }
                if (args.eol()) {
          ...
          redo: CodeMirror3.commands.redo,
          undo: CodeMirror3.commands.undo,
          write: function(cm) {
            if (CodeMirror3.commands.save) {
              CodeMirror3.commands.save(cm);
            } else if (cm.save) {
              cm.save();
            }
          },
          ...
          delmarks: function(cm, params) {
            ...
            var stream = new CodeMirror3.StringStream(trim(params.argString));
            while (!stream.eol()) {
              stream.eatSpace();
        ...
        function exitInsertMode(cm) {
          ...
          if (!isPlaying) {
            ...
            CodeMirror3.off(cm.getInputField(), "keydown", onKeyEventTargetKeyDown);
          }
        ...
        CodeMirror3.keyMap["vim-replace"] = {
        ...
        function handleExternalSelection(cm, vim) {
          ...
          if (vim.visualMode && !cm.somethingSelected()) {
            ...
            vim.visualMode = true;
            vim.visualLine = false;
            CodeMirror3.signal(cm, "vim-mode-change", { mode: "visual" });
          }
          if (vim.visualMode) {
        ...
        function onKeyEventTargetKeyDown(e) {
          ...
          if (keyName.indexOf("Delete") != -1 || keyName.indexOf("Backspace") != -1) {
            CodeMirror3.lookupKey(keyName, "vim-insert", onKeyFound);
          }
        }
        ...
        function repeatInsertModeChanges(cm, changes, repeat) {
          function keyHandler(binding) {
            if (typeof binding == "string") {
              CodeMirror3.commands[binding](cm);
            } else {
              binding(cm);
            }
            return true;
          ...
          for (var i = 0; i < repeat; i++) {
            ...
            for (var j = 0; j < changes.length; j++) {
              ...
              if (change instanceof InsertModeKey) {
                CodeMirror3.lookupKey(change.keyName, "vim-insert", keyHandler);
      ...
      CodeMirror2.Vim = initVim(CodeMirror2);
    });
  }
});
export default require_vim();
//# sourceMappingURL=codemirror_keymap_vim.js.map
