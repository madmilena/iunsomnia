import {
  ...
  require_toKey,
  require_toSource
} from "./chunk-GYSW4AER.js";
import {
  require_fast_uri
} from "./chunk-ZSUZWGP5.js";
import {
  require_jsx_runtime
} from "./chunk-XD2P2GJD.js";
import {
  require_react
...
function maybeAddDefaultToObject(obj, key, computedDefault, includeUndefinedValues, isParentRequired, requiredFields = [], experimental_defaultFormStateBehavior = {}, isConst = false) {
  ...
  if (includeUndefinedValues === true || isConst) {
    ...
    if (!isObject(computedDefault) || !isEmpty_default(computedDefault)) {
      obj[key] = computedDefault;
    }
    ...
    if (sameSchemaIndex === -1) {
      ...
      allOptions.forEach((s) => {
        if (PROPERTIES_KEY in s && s[PROPERTIES_KEY]) {
          forEach_default(schema2[PROPERTIES_KEY], (value) => {
...
//# sourceMappingURL=chunk-3LI2W2HJ.js.map
