...
var require_vkbeautify = __commonJS({
  "../../node_modules/vkbeautify/index.js"(exports, module) {
    ...
    vkbeautify.prototype.sql = function(text, step) {
      var ar_by_quote = text.replace(/\s{1,}/g, " ").replace(/\'/ig, "~::~'").split("~::~"), len = ar_by_quote.length, ar = [], deep = 0, tab = this.step, inComment = true, inQuote = false, parenthesisLevel = 0, str = "", ix = 0, shift = step ? createShiftArr(step) : this.shift;
      ;
      for (ix = 0; ix < len; ix++) {
        if (ix % 2) {
...
export default require_vkbeautify();
