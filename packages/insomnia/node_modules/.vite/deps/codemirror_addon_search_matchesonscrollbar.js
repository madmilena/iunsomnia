    ...
    (function(mod) {
      ...
      SearchAnnotation.prototype.onChange = function(change) {
        ...
        if (sizeChange) for (var i = 0; i < this.matches.length; i++) {
          ...
          if (newFrom != match.from.line) match.from = CodeMirror2.Pos(newFrom, match.from.ch);
          var newTo = offsetLine(match.to.line, startLine, sizeChange);
          if (newTo != match.to.line) match.to = CodeMirror2.Pos(newTo, match.to.ch);
        }
...
export default require_matchesonscrollbar();
//# sourceMappingURL=codemirror_addon_search_matchesonscrollbar.js.map
