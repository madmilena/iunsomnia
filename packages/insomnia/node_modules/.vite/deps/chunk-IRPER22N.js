// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/environment/index.js
function isBrowser() {
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/global-analytics-helper.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/embedded-write-key.js
try {
  window.analyticsWriteKey = "__WRITE_KEY__";
} catch (_) {
}

// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/parse-cdn.js
var analyticsScriptRegex = /(https?:\/\/[\w.\-:]+)\/(?:analytics\.js\/v1|v1\/analytics-js\/snippet)\/[\w\-:]+\/(analytics\.(?:min)\.js)/;
var getCDNUrlFromScriptTag = function() {
  ...
  for (var _i = 0, scripts_1 = scripts; _i < scripts_1.length; _i++) {
    ...
    if (((_b = s.dataset) === null || _b === void 0 ? void 0 : _b.globalCustomerioAnalyticsKey) != null) {
      break;
    }
  }
  return cdn;
...
var getNextIntegrationsURL = function() {
  var cdn = getCDN();
  return "".concat(cdn, "/v1/analytics-js/actions");
};

// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/load-script.js
...
//# sourceMappingURL=chunk-IRPER22N.js.map
