...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/ajs-destination/index.js
var import_facade = __toESM(require_dist());

// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/ajs-destination/loader.js
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          fullPath = "".concat(path, "/").concat(obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName, ".js?version=").concat(version);
          _a.label = 1;
        case 1:
          _a.trys.push([1, 3, , 4]);
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/ajs-destination/utils.js
var isInstallableIntegration = function(name, integrationSettings) {
  ...
  return name !== "Customer.io Data Pipelines" && name !== "Iterable" && deviceMode;
};
...
var LegacyDestination = (
  /** @class */
  (function() {
    function LegacyDestination2(name, version, settings, options, integrationSource) {
      if (settings === void 0) {
        settings = {};
      }
      this.options = {};
            ...
            case 0:
              ...
              if (plan && ev && this.name !== "Customer.io Data Pipelines") {
                ...
                if (!isPlanEventEnabled(plan, planEvent)) {
                  ctx.updateEvent("integrations", __assign(__assign({}, ctx.event.integrations), { All: false, "Customer.io Data Pipelines": true }));
...
//# sourceMappingURL=ajs-destination-NJEQLZV3.js.map
