...
var require_order = __commonJS({
  "../../node_modules/json-order/dist/order.js"(exports) {
    "use strict";
    ...
    var getProperty = function(obj, key, separator) {
      var exists = true;
      var value = key.split(separator).filter(function(s) {
        return s.length > 0;
      }).reduce(function(o, x) {
    ...
    var setProperty = function(obj, key, value, separator) {
      key.split(separator).filter(function(s) {
        return s.length > 0;
      }).reduce(function(o, x, idx, src) {
        if (idx === src.length - 1) {
          var valueToSet = Array.isArray(value) ? lodash_clonedeep_1.default(value).map(function(p) {
...
var require_parse = __commonJS({
  "../../node_modules/json-order/dist/parse.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_stringify = __commonJS({
  "../../node_modules/json-order/dist/stringify.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var stringify = function(sourceObject, map, separator, space) {
      if (separator === void 0) {
        separator = "~";
      }
      return JSON.stringify(order_1.default(sourceObject, map, separator), null, space);
    };
...
var require_dist = __commonJS({
  "../../node_modules/json-order/dist/index.js"(exports) {
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var stringify_1 = __importDefault(require_stringify());
    var orderedJSON = { parse: parse_1.default, stringify: stringify_1.default, order: order_1.default };
    exports.default = orderedJSON;
  }
});
export default require_dist();
//# sourceMappingURL=json-order.js.map
