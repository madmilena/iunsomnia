import {
  InAppEvents,
  InAppPlugin
} from "./chunk-HV6BT3KT.js";
import {
  PersistedPriorityQueue,
  isOffline,
  mergedOptions,
  pWhile
} from "./chunk-AUYBFO2F.js";
import {
  getCDN,
  getGlobalAnalytics,
  loadScript,
...
import {
  ...
  dset,
  v4
} from "./chunk-XCHVDNM2.js";
import "./chunk-H7ZCDJ7T.js";
import {
  __commonJS,
  __toESM
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/validation/index.js
...
function hasUser(event) {
  var _a2, _b2, _c;
  var id = (_c = (_b2 = (_a2 = event.userId) !== null && _a2 !== void 0 ? _a2 : event.anonymousId) !== null && _b2 !== void 0 ? _b2 : event.groupId) !== null && _c !== void 0 ? _c : event.previousId;
  return isString(id);
}
var ValidationError = (
  /** @class */
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/arguments-resolver/index.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/events/index.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/queue/event-queue.js
var EventQueue = (
  /** @class */
  (function(_super) {
    __extends(EventQueue2, _super);
    function EventQueue2(priorityQueue) {
      return _super.call(this, priorityQueue !== null && priorityQueue !== void 0 ? priorityQueue : new PersistedPriorityQueue(4, "event-queue")) || this;
    }
    return EventQueue2;
  })(CoreEventQueue)
);

// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/analytics/index.js
  ...
  (function(_super) {
    ...
    Analytics2.prototype.track = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, name, data, opts, cb, CustomerioEvent;
        var _this = this;
        return __generator(this, function(_b2) {
          _a2 = resolveArguments.apply(void 0, args), name = _a2[0], data = _a2[1], opts = _a2[2], cb = _a2[3];
          CustomerioEvent = this.eventFactory.track(name, data, opts, this.integrations);
          return [2, this._dispatch(CustomerioEvent, cb).then(function(ctx) {
    ...
    Analytics2.prototype.page = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, category, page, properties, options, callback, CustomerioEvent;
        var _this = this;
        return __generator(this, function(_b2) {
          _a2 = resolvePageArguments.apply(void 0, args), category = _a2[0], page = _a2[1], properties = _a2[2], options = _a2[3], callback = _a2[4];
          CustomerioEvent = this.eventFactory.page(category, page, properties, options, this.integrations);
          return [2, this._dispatch(CustomerioEvent, callback).then(function(ctx) {
    ...
    Analytics2.prototype.identify = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, id, _traits, options, callback, CustomerioEvent;
        var _this = this;
        return __generator(this, function(_b2) {
          _a2 = resolveUserArguments(this._user).apply(void 0, args), id = _a2[0], _traits = _a2[1], options = _a2[2], callback = _a2[3];
          this._user.identify(id, _traits);
          CustomerioEvent = this.eventFactory.identify(this._user.id(), this._user.traits(), options, this.integrations);
          return [2, this._dispatch(CustomerioEvent, callback).then(function(ctx) {
    ...
    Analytics2.prototype.group = function() {
      ...
      var CustomerioEvent = this.eventFactory.group(groupId, groupTraits, options, this.integrations);
      return this._dispatch(CustomerioEvent, callback).then(function(ctx) {
    ...
    Analytics2.prototype.alias = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, to, from, options, callback, CustomerioEvent;
        var _this = this;
        return __generator(this, function(_b2) {
          _a2 = resolveAliasArguments.apply(void 0, args), to = _a2[0], from = _a2[1], options = _a2[2], callback = _a2[3];
          CustomerioEvent = this.eventFactory.alias(to, from, options, this.integrations);
          return [2, this._dispatch(CustomerioEvent, callback).then(function(ctx) {
    ...
    Analytics2.prototype.screen = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b2) {
          _a2 = resolvePageArguments.apply(void 0, args), category = _a2[0], page = _a2[1], properties = _a2[2], options = _a2[3], callback = _a2[4];
          CustomerioEvent = this.eventFactory.screen(category, page, properties, options, this.integrations);
          return [2, this._dispatch(CustomerioEvent, callback).then(function(ctx) {
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/get-process-env.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/create-deferred.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/page-enrichment/index.js
function canonical() {
...
function enrichPageContext(ctx) {
  ...
  var pageProps = (_a2 = event.properties) !== null && _a2 !== void 0 ? _a2 : {};
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/remote-loader/index.js
              ...
              return __generator(this, function(_a3) {
                switch (_a3.label) {
                  ...
                  case 1:
                    ...
                    defaultCdn = new RegExp("https://cdp.customer.io");
                    if (!obfuscate) return [3, 7];
                  ...
                  case 9:
                    ...
                    if (!(typeof window[libraryName] === "function")) return [3, 11];
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/on-page-leave.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/customerio/batched-dispatcher.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/customerio/fetch-dispatcher.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/customerio/schedule-flush.js
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/plugins/customerio/index.js
...
function customerio(analytics, settings, integrations) {
  var _a2, _b2;
  window.addEventListener("pagehide", function() {
    buffer.push.apply(buffer, Array.from(inflightEvents));
    inflightEvents.clear();
  });
  var buffer = analytics.options.disableClientPersistence ? new PriorityQueue(analytics.queue.queue.maxAttempts, []) : new PersistedPriorityQueue(analytics.queue.queue.maxAttempts, "dest-Customer.io-Data-Pipelines");
  var inflightEvents = /* @__PURE__ */ new Set();
  var flushing = false;
  var apiHost = (_a2 = settings === null || settings === void 0 ? void 0 : settings.apiHost) !== null && _a2 !== void 0 ? _a2 : "cdp.customer.io/v1";
  var protocol = (_b2 = settings === null || settings === void 0 ? void 0 : settings.protocol) !== null && _b2 !== void 0 ? _b2 : "https";
  ...
  var client = (deliveryStrategy === null || deliveryStrategy === void 0 ? void 0 : deliveryStrategy.strategy) === "batching" ? batch(remote, deliveryStrategy.config) : fetch_dispatcher_default(deliveryStrategy === null || deliveryStrategy === void 0 ? void 0 : deliveryStrategy.config);
  function send(ctx) {
    return __awaiter(this, void 0, void 0, function() {
      var path, json;
      return __generator(this, function(_a3) {
        if (isOffline()) {
          buffer.push(ctx);
          scheduleFlush(flushing, buffer, customerio2, scheduleFlush);
          return [2, ctx];
        }
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/lib/is-thenable.js
var isThenable = function(value) {
  return typeof value === "object" && value !== null && "then" in value && typeof value.then === "function";
};

// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/buffer/index.js
...
var AnalyticsBuffered = (
  ...
  (function() {
    ...
    AnalyticsBuffered2.prototype.inbox = function() {
      var _a2;
      var _b2;
      var topics = [];
      for (var _i = 0; _i < arguments.length; _i++) {
      ...
      if ((_b2 = this.instance) === null || _b2 === void 0 ? void 0 : _b2.inbox) {
        return (_a2 = this.instance).inbox.apply(_a2, topics);
      }
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/buffer/snippet.js
...
var popSnippetWindowBuffer = function(buffer) {
  if (buffer === void 0) {
    buffer = getGlobalAnalytics();
  }
  var wa = buffer;
  if (!Array.isArray(wa))
    return [];
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/core/inspector/index.js
var _a;
var _b;
var env = getGlobal();
var inspectorHost = (_a = (_b = env)["__INSPECTOR__"]) !== null && _a !== void 0 ? _a : _b["__INSPECTOR__"] = {};
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/browser/index.js
...
function hasLegacyDestinations(settings) {
  return getProcessEnv().NODE_ENV !== "test" && // just one integration means customerio
...
function registerPlugins(legacySettings, analytics, opts, options, plugins, legacyIntegrationSources) {
  var _a2, _b2, _c, _d;
  return __awaiter(this, void 0, void 0, function() {
    var tsubMiddleware, _e, legacyDestinations, _f, schemaFilter, _g, mergedSettings, remotePlugins, inAppPluginName, inAppPluginSettings, inAppPlugin, _h, toRegister, shouldIgnore, ctx;
    var _this = this;
    return __generator(this, function(_j) {
      switch (_j.label) {
        case 0:
          if (!hasTsubMiddleware(legacySettings)) return [3, 2];
          return [4, import(
            /* webpackChunkName: "tsub-middleware" */
            "./routing-middleware-X24SNSZR.js"
          ).then(function(mod) {
        ...
        case 3:
          tsubMiddleware = _e;
          if (!(hasLegacyDestinations(legacySettings) || legacyIntegrationSources.length > 0)) return [3, 5];
          return [4, import(
            /* webpackChunkName: "ajs-destination" */
            "./ajs-destination-NJEQLZV3.js"
          ).then(function(mod) {
        ...
        case 5:
          ...
          _j.label = 6;
        case 6:
          legacyDestinations = _f;
          if (!legacySettings.legacyVideoPluginsEnabled) return [3, 8];
          return [4, import(
            /* webpackChunkName: "legacyVideos" */
            "./legacy-video-plugins-MDJGBMQI.js"
          ).then(function(mod) {
        ...
        case 7:
          ...
          _j.label = 8;
        case 8:
          if (!((_a2 = opts.plan) === null || _a2 === void 0 ? void 0 : _a2.track)) return [3, 10];
          return [4, import(
            /* webpackChunkName: "schemaFilter" */
            "./schema-filter-6EMYBOWP.js"
          ).then(function(mod) {
            var _a3;
        ...
        case 12:
          ...
          inAppPluginName = "Customer.io In-App Plugin";
          inAppPluginSettings = mergedSettings[inAppPluginName];
          if (!inAppPluginSettings) {
            inAppPluginSettings = (_b2 = options.integrations) === null || _b2 === void 0 ? void 0 : _b2[inAppPluginName];
          }
          if (!inAppPluginSettings) return [3, 14];
          return [4, import(
            /* webpackChunkName: "inAppPlugin" */
            "./in-app-plugin-2JAQTO4C.js"
          ).then(function(mod) {
        ...
        case 15:
          ...
          shouldIgnore = ((_c = opts.integrations) === null || _c === void 0 ? void 0 : _c.All) === false && !opts.integrations["Customer.io Data Pipelines"] || opts.integrations && opts.integrations["Customer.io Data Pipelines"] === false;
          if (!shouldIgnore) {
            toRegister.push(customerio(analytics, mergedSettings["Customer.io Data Pipelines"], legacySettings.integrations));
          }
          return [4, analytics.register.apply(analytics, toRegister)];
        case 16:
          ctx = _j.sent();
          if (!Object.entries((_d = legacySettings.enabledMiddleware) !== null && _d !== void 0 ? _d : {}).some(function(_a3) {
            var enabled = _a3[1];
            return enabled;
          })) return [3, 18];
          return [4, import(
            /* webpackChunkName: "remoteMiddleware" */
            "./remote-middleware-BYJLT7QY.js"
          ).then(function(_a3) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_j) {
      switch (_j.label) {
        ...
        case 3:
          legacySettings = _h;
          retryQueue = (_c = (_b2 = legacySettings.integrations["Customer.io Data Pipelines"]) === null || _b2 === void 0 ? void 0 : _b2.retryQueue) !== null && _c !== void 0 ? _c : true;
          ...
          return [4, registerPlugins(legacySettings, analytics, opts, options, plugins, classicIntegrations)];
        case 4:
          ctx = _j.sent();
          ...
          if (!term.includes("ajs_")) return [3, 6];
...
// ../../node_modules/@customerio/cdp-analytics-browser/dist/pkg/node/node.browser.js
var AnalyticsNode = (
  /** @class */
  (function() {
...
//# sourceMappingURL=@customerio_cdp-analytics-browser.js.map
