...
} from "./chunk-IHJZPKOX.js";
import {
  _class_private_field_init
} from "./chunk-RKTEXCE4.js";
import {
  require_react_dom
} from "./chunk-4YRBNWZD.js";
import {
  require_react
} from "./chunk-BJP5GRYC.js";
import {
  __toESM
...
function $1dbecbe27a04f9af$export$14d238f342723f25(defaultValue) {
  ...
  let currValue = (0, import_react2.useRef)(value);
  let effect = (0, import_react2.useRef)(null);
  let nextRef = (0, import_react2.useRef)(() => {
...
function $5df64b3807dc15ee$export$d699905dd57c73ca() {
  ...
  let [size, setSize] = (0, import_react13.useState)(() => isSSR ? {
    width: 0,
    height: 0
  ...
  (0, import_react13.useEffect)(() => {
    ...
    let onBlur = (e) => {
      if ($5df64b3807dc15ee$var$visualViewport && $5df64b3807dc15ee$var$visualViewport.scale > 1) return;
      if ((0, $21f1aa98acb08317$export$c57958e35f31ed73)((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)))
...
function $a5fa973c1850dd36$export$ccaea96c28e8b9e7(props, ref) {
  ...
  let sentinelObserver = (0, import_react19.useRef)(null);
...
function $cdc5a6778b766db2$export$a9d04c5684123369(value) {
  const pieces = (0, import_react20.version).split(".");
...
function $d3f049242431219c$export$6d3443f2c48bfc20(ref, isReady = true) {
  let [isEntering, setEntering] = (0, import_react21.useState)(true);
  ...
  $d3f049242431219c$var$useAnimation(ref, isAnimationReady, (0, import_react21.useCallback)(() => setEntering(false), []));
  return isAnimationReady;
}
function $d3f049242431219c$export$45fda7c47f93fd48(ref, isOpen) {
  let [exitState, setExitState] = (0, import_react21.useState)(isOpen ? "open" : "closed");
  switch (exitState) {
    case "open":
  ...
  $d3f049242431219c$var$useAnimation(ref, isExiting, (0, import_react21.useCallback)(() => {
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
  ...
  let triggerPressStart = (0, import_react24.useCallback)((originalEvent, pointerType) => {
  ...
  let triggerPressEnd = (0, import_react24.useCallback)((originalEvent, pointerType, wasPressed = true) => {
    let state = ref.current;
  ...
  let triggerPressUp = (0, import_react24.useCallback)((originalEvent, pointerType) => {
    let state = ref.current;
  ...
  let cancel = (0, import_react24.useCallback)((e) => {
    let state = ref.current;
  ...
  let cancelOnPointerExit = (0, import_react24.useCallback)((e) => {
    if (shouldCancelOnPointerExit) cancel(e);
  }, [
    shouldCancelOnPointerExit,
    cancel
  ]);
  let triggerClick = (0, import_react24.useCallback)((e) => {
  ...
  let triggerSyntheticClick = (0, import_react24.useCallback)((e, target) => {
    if (isDisabled) return;
    if (onClick) {
  ...
  let [isElemKeyPressed, setIsElemKeyPressed] = (0, import_react24.useState)(false);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    let state = ref.current;
    if (isElemKeyPressed) {
      let onKeyUp = (e) => {
  ...
  let [isPointerPressed, setIsPointerPressed] = (0, import_react24.useState)(null);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    let state = ref.current;
...
function $507fabe10e71c6fb$export$98e20ec92f614cfe() {
  ...
  let [modality, setModality] = (0, import_react25.useState)($507fabe10e71c6fb$var$currentModality);
...
function $507fabe10e71c6fb$var$isKeyboardFocusEvent(isTextInput, modality, e) {
  let document1 = (0, $431fbd86ca7dc216$export$b204af158042fbac)(e ? (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e) : void 0);
  let eventTarget = e ? (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e) : void 0;
  ...
  let activeElement = (0, $d4ee10de306f2510$export$cd4e5573fbe2b576)(document1);
...
function $507fabe10e71c6fb$export$ffd9e5021c1fb2d6(props = {}) {
  ...
  let [isFocusVisibleState, setFocusVisible] = (0, import_react25.useState)(autoFocus || $507fabe10e71c6fb$export$b9b3dfddab17db27());
...
function $9ab94262bd0047c7$export$420e68273165f4ec(props) {
  ...
  let onBlur = (0, import_react30.useCallback)((e) => {
    if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e))) return;
    if (state.current.isFocusWithin && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, e.relatedTarget)) {
  ...
  let onFocus = (0, import_react30.useCallback)((e) => {
    ...
    if (!state.current.isFocusWithin && activeElement === eventTarget) {
      ...
      addGlobalListener(ownerDocument, "focus", (e2) => {
        let eventTarget2 = (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e2);
...
function $6179b936705e76d3$export$ae780daf29e6d456(props) {
  ...
  let { hoverProps, triggerHoverEnd } = (0, import_react31.useMemo)(() => {
    let triggerHoverStart = (event, pointerType) => {
      ...
      state.target = target;
      addGlobalListener((0, $431fbd86ca7dc216$export$b204af158042fbac)((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(event)), "pointerover", (e) => {
        if (state.isHovered && state.target && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(state.target, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e))) triggerHoverEnd2(e, e.pointerType);
      }, {
        capture: true
      });
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      hoverProps2.onPointerLeave = (e) => {
        if (!isDisabled && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e))) triggerHoverEnd2(e, e.pointerType);
      };
    } else if (false) {
      ...
      hoverProps2.onMouseLeave = (e) => {
        if (!isDisabled && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e))) triggerHoverEnd2(e, "mouse");
      };
    }
    return {
...
function $e0b6e0b68ec7f50f$var$isValidEvent(event, ref) {
  ...
  let target = (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(event);
  if (target) {
    const ownerDocument = target.ownerDocument;
    if (!ownerDocument || !(0, $d4ee10de306f2510$export$4282f70798064fe0)(ownerDocument.documentElement, target)) return false;
...
function $e8a7022cf87cba2a$export$36da96379f79f245(props) {
  ...
  let move = (0, import_react33.useCallback)((originalEvent, pointerType, deltaX, deltaY) => {
  ...
  let end = (0, import_react33.useCallback)((originalEvent, pointerType) => {
  ...
  let [pointerDown, setPointerDown] = (0, import_react33.useState)(null);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
  ...
  let moveProps = (0, import_react33.useMemo)(() => {
    let moveProps2 = {};
    let start = () => {
...
function $7d0a636d7a4dcefd$export$2123ff2b87c81ca(props, ref) {
  ...
  let onScrollHandler = (0, import_react34.useCallback)((e) => {
    if (e.ctrlKey) return;
    e.preventDefault();
    e.stopPropagation();
...
//# sourceMappingURL=chunk-QMMFOJJK.js.map
