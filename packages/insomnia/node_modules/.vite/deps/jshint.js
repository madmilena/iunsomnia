...
// ../../node_modules/jshint/node_modules/lodash/lodash.js
var require_lodash = __commonJS({
  "../../node_modules/jshint/node_modules/lodash/lodash.js"(exports, module) {
    (function() {
      var undefined2;
      var VERSION = "4.17.23";
...
var require_vars = __commonJS({
  "../../node_modules/jshint/src/vars.js"(exports) {
    "use strict";
...
var require_messages = __commonJS({
  "../../node_modules/jshint/src/messages.js"(exports) {
    "use strict";
...
var require_reg = __commonJS({
  "../../node_modules/jshint/src/reg.js"(exports) {
    "use strict";
...
var require_name_stack = __commonJS({
  "../../node_modules/jshint/src/name-stack.js"(exports, module) {
    "use strict";
    function NameStack() {
      this._stack = [];
    }
...
var require_state = __commonJS({
  "../../node_modules/jshint/src/state.js"(exports) {
    "use strict";
    var NameStack = require_name_stack();
    var state = {
      syntax: {},
      /**
...
var require_ascii_identifier_data = __commonJS({
  "../../node_modules/jshint/data/ascii-identifier-data.js"(exports, module) {
...
var require_non_ascii_identifier_start = __commonJS({
  "../../node_modules/jshint/data/non-ascii-identifier-start.js"(exports, module) {
...
var require_non_ascii_identifier_part_only = __commonJS({
  "../../node_modules/jshint/data/non-ascii-identifier-part-only.js"(exports, module) {
...
// ../../node_modules/jshint/data/es5-identifier-names.js
var require_es5_identifier_names = __commonJS({
  "../../node_modules/jshint/data/es5-identifier-names.js"(exports, module) {
...
// ../../node_modules/jshint/src/validate-unicode-escape-sequence.js
var require_validate_unicode_escape_sequence = __commonJS({
  "../../node_modules/jshint/src/validate-unicode-escape-sequence.js"(exports, module) {
    "use strict";
...
var require_lex = __commonJS({
  "../../node_modules/jshint/src/lex.js"(exports) {
    "use strict";
    var _ = require_lodash();
    var events = require_events();
    var reg = require_reg();
    var state = require_state().state;
    var unicodeData = require_ascii_identifier_data();
    var asciiIdentifierStartTable = unicodeData.asciiIdentifierStartTable;
    var asciiIdentifierPartTable = unicodeData.asciiIdentifierPartTable;
    var nonAsciiIdentifierStartTable = require_non_ascii_identifier_start();
    var nonAsciiIdentifierPartTable = require_non_ascii_identifier_part_only();
    ...
    Lexer.prototype = {
      ...
      scanIdentifier: function(checks) {
        ...
        if (!state.inES6(true)) {
          es5IdentifierNames = require_es5_identifier_names();
      ...
      scanRegExp: function(checks) {
        ...
        var scanRegexpEscapeSequence = (function() {
          ...
          if (char === "p" || char === "P") {
            ...
            if (!sequence || !require_validate_unicode_escape_sequence()(sequence)) {
              this.triggerAsync(
                "error",
                {
                  code: "E016",
...
var require_style = __commonJS({
  "../../node_modules/jshint/src/style.js"(exports) {
    "use strict";
...
var require_options = __commonJS({
  "../../node_modules/jshint/src/options.js"(exports) {
    "use strict";
    exports.bool = {
      enforcing: {
        /**
...
var require_scope_manager = __commonJS({
  "../../node_modules/jshint/src/scope-manager.js"(exports, module) {
    "use strict";
    var _ = require_lodash();
    var events = require_events();
    var marker = {};
            ...
            for (i = 0; i < bindingNames.length; i++) {
              ...
              if (!defBinding["(blockscoped)"] && defBinding["(type)"] !== "exception") {
                ...
                if (shadowed) {
                  ...
                  defBinding["(useOutsideOfScope)"] = // Do not warn about out-of-scope usages in the global scope
                  _currentFunctBody["(type)"] !== "global" && // When a higher scope contains a binding for the binding, the
...
var require_prod_params = __commonJS({
  "../../node_modules/jshint/src/prod-params.js"(exports, module) {
    module.exports = {
      /**
...
// vite:cjs-external-facade:assert
import * as m from "assert";
var require_assert = __commonJS({
  "vite:cjs-external-facade:assert"(exports, module) {
...
var require_jshint = __commonJS({
  "../../node_modules/jshint/src/jshint.js"(exports) {
    var _ = require_lodash();
    var events = require_events();
    var vars = require_vars();
    var messages = require_messages();
    var Lexer = require_lex().Lexer;
    var reg = require_reg();
    var state = require_state().state;
    var style = require_style();
    var options = require_options();
    var scopeManager = require_scope_manager();
    var prodParams = require_prod_params();
    var console = require_console_browserify();
    var JSHINT = (function() {
      "use strict";
      var api, bang = {
        "<": true,
      ...
      function warningAt(m2, l, ch, a, b, c, d) {
        return warning(m2, {
          line: l,
          from: ch
        }, a, b, c, d);
      }
      function error(m2, t, a, b, c, d) {
        warning(m2, t, a, b, c, d);
      }
      function errorAt(m2, l, ch, a, b, c, d) {
        return error(m2, {
          line: l,
          from: ch
        }, a, b, c, d);
      ...
      function lintingDirective(directiveToken, previous) {
        ...
        if (directiveToken.type === "members") {
          ...
          body.forEach(function(m2) {
            var ch1 = m2.charAt(0);
            var ch2 = m2.charAt(m2.length - 1);
            if (ch1 === ch2 && (ch1 === '"' || ch1 === "'")) {
              m2 = m2.substr(1, m2.length - 2).replace('\\"', '"');
            }
            membersOnly[m2] = false;
          });
        }
        var numvals = [
          "maxstatements",
      ...
      function block(context, ordinary, stmt2, isfunc, isfatarrow, iscase) {
        var a, b = inblock, old_indent = indent, m2, t, d;
        inblock = ordinary;
        t = state.tokens.next;
          ...
          if (state.tokens.next.id !== "}") {
            ...
            if (isfunc) {
              ...
              for (d in state.directive) {
                m2[d] = state.directive[d];
              }
              directives();
              state.funct["(isStrict)"] = state.isStrict();
              if (state.option.strict && state.funct["(context)"]["(global)"]) {
                if (!m2["use strict"] && !state.isStrict()) {
                  warning("E007");
                }
              }
            }
      ...
      function countMember(m2) {
        if (membersOnly && typeof membersOnly[m2] !== "boolean") {
          warning("W036", state.tokens.curr, m2);
        }
        if (typeof member[m2] === "number") {
          member[m2] += 1;
        } else {
          member[m2] = 1;
        }
      ...
      infix(".", function(context, left, that) {
        var m2 = identifier(context, true);
        if (typeof m2 === "string") {
          countMember(m2);
        }
        that.left = left;
        that.right = m2;
        if (m2 && m2 === "hasOwnProperty" && state.tokens.next.value === "=") {
          warning("W001");
        }
        if (left && left.value === "arguments" && (m2 === "callee" || m2 === "caller")) {
          if (state.option.noarg)
            warning("W059", left, m2);
          else if (state.isStrict())
            error("E008");
        } else if (!state.option.evil && left && left.value === "document" && (m2 === "write" || m2 === "writeln")) {
          warning("W060", left);
        }
        if (!state.option.evil && (m2 === "eval" || m2 === "execScript")) {
