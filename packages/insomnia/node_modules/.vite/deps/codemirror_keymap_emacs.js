...
var require_emacs = __commonJS({
  "../../node_modules/codemirror/keymap/emacs.js"(exports, module) {
    (function(mod) {
      ...
      function _kill(cm, from, to, ring, text) {
        ...
        if (ring == "grow") lastKill = { cm, pos: from, gen: cm.changeGeneration() };
        else lastKill = null;
      }
      ...
      function byExpr(cm, pos, dir) {
        var wrap;
        if (cm.findMatchingBracket && (wrap = cm.findMatchingBracket(pos, { strict: true })) && wrap.match && (wrap.forward ? 1 : -1) == dir)
      ...
      function repeated(cmd) {
        ...
        return function(cm) {
          ...
          f(cm);
          for (var i2 = 1; i2 < prefix; ++i2) f(cm);
        };
      }
      ...
      function killTo(cm, by, dir, ring) {
        ...
        var i2 = selections.length;
        while (i2--) {
          cursor = selections[i2].head;
      ...
      function maybeDuplicateInput(cm, event) {
        ...
        if (dup > 1 && event.origin == "+input") {
          ...
          for (var i2 = 1; i2 < dup; ++i2) txt += one;
      ...
      function toEnclosingExpr(cm) {
        ...
        while (line >= cm.firstLine()) {
          ...
          for (var i2 = ch == null ? text.length : ch; i2 > 0; ) {
            ...
            if (ch == ")")
              ...
              return cm.extendSelection(Pos(line, i2));
          }
          --line;
          ch = null;
        }
      ...
      CodeMirror2.emacs = { kill: _kill, killRegion: _killRegion, repeated };
      var keyMap = CodeMirror2.keyMap.emacs = CodeMirror2.normalizeKeyMap({
        "Ctrl-W": "killRegion",
...
//# sourceMappingURL=codemirror_keymap_emacs.js.map
