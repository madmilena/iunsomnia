...
var insertSuffix, getInsertText, getInputInsertText, getFieldInsertText;
var init_autocompleteUtils = __esm({
  "../../node_modules/graphql-language-service/esm/interface/autocompleteUtils.js"() {
   ...
   $${n !== null && n !== void 0 ? n : 1}
    ...
    getInsertText = (prefix, type2, fallback) => {
      if (!type2) {
    ...
    getInputInsertText = (prefix, type2, fallback) => {
      if (isListType(type2)) {
...
var GraphQLDocumentMode, TYPE_SYSTEM_KINDS, getParsedMode;
var init_api = __esm({
  "../../node_modules/graphql-language-service/esm/parser/api.js"() {
    init_parser();
    init_graphql();
...
// ../../node_modules/graphql-language-service/esm/parser/index.js
...
var FileChangeTypeKind, CompletionItemKind2;
...
var SuggestionCommand, collectFragmentDefs, typeSystemCompletionItems, executableCompletionItems, getParentDefinition;
...
var init_fragmentDependencies = __esm({
  "../../node_modules/graphql-language-service/esm/utils/fragmentDependencies.js"() {
    init_graphql();
    import_nullthrows = __toESM(require_nullthrows());
...
var defaultScalarTypesMap, Marker;
var init_getVariablesJSONSchema = __esm({
  "../../node_modules/graphql-language-service/esm/utils/getVariablesJSONSchema.js"() {
    init_graphql();
...
// ../../node_modules/graphql-language-service/esm/utils/getASTNodeAtPosition.js
...
function locToRange(text3, loc) {
  const start = offsetToPosition(text3, loc.start);
  const end = offsetToPosition(text3, loc.end);
  return new Range2(start, end);
}
var Range2, Position2;
...
var init_collectVariables = __esm({
  "../../node_modules/graphql-language-service/esm/utils/collectVariables.js"() {
    init_graphql();
  }
});
...
var getQueryFacts;
var init_getOperationFacts = __esm({
  "../../node_modules/graphql-language-service/esm/utils/getOperationFacts.js"() {
    init_graphql();
    init_collectVariables();
    getQueryFacts = getOperationFacts;
  }
});

// ../../node_modules/graphql-language-service/esm/utils/index.js
var init_utils = __esm({
  "../../node_modules/graphql-language-service/esm/utils/index.js"() {
    ...
    init_collectVariables();
    init_getOperationFacts();
  }
});

// ../../node_modules/graphql-language-service/esm/interface/getDefinition.js
function assert(value, message) {
  if (!value) {
    throw new Error(message);
  }
}
function getRange(text3, node) {
...
function getDefinitionQueryResultForFragmentSpread(text3, fragment, dependencies) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (defNodes.length === 0) {
      throw new Error(`Definition not found for GraphQL fragment ${name2}`);
    }
    ...
    return {
      definitions,
      queryRange: definitions.map((_) => getRange(text3, fragment)),
      printedName: name2
    };
  });
}
function getDefinitionQueryResultForDefinitionNode(path, text3, definition) {
  ...
  return {
    ...
    queryRange: definition.name ? [getRange(text3, definition.name)] : [],
...
function getDefinitionForFragmentDefinition(path, text3, definition) {
  ...
  return {
    ...
    range: getRange(text3, definition),
    name: name2.value || "",
    language: LANGUAGE,
    projectRoot: path
  };
...
function getDefinitionForFieldDefinition(path, text3, definition) {
  const { name: name2 } = definition;
  assert(name2, "Expected ASTNode to have a Name.");
  return {
    path,
...
function getDefinitionForArgumentDefinition(path, text3, definition) {
  const { name: name2 } = definition;
  assert(name2, "Expected ASTNode to have a Name.");
  return {
    path,
...
${fragments}` : query;
  try {
    ...
    if (error instanceof GraphQLError) {
      const range = getRange2((_b = (_a = error.locations) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : { line: 0, column: 0 }, enhancedQuery);
      return [
        {
...
var SEVERITY, DIAGNOSTIC_SEVERITY, invariant;
...
// ../../node_modules/graphql-language-service/esm/interface/index.js
...
// ../../node_modules/graphql-language-service/esm/index.js
var esm_exports = {};
__export(esm_exports, {
  CharacterStream: () => CharacterStream,
  CompletionItemKind: () => CompletionItemKind2,
  DIAGNOSTIC_SEVERITY: () => DIAGNOSTIC_SEVERITY,
  FileChangeTypeKind: () => FileChangeTypeKind,
  GraphQLDocumentMode: () => GraphQLDocumentMode,
  LexRules: () => LexRules,
  ParseRules: () => ParseRules,
  Position: () => Position2,
  ...
  getContextAtPosition: () => getContextAtPosition,
  getDefinitionQueryResultForArgument: () => getDefinitionQueryResultForArgument,
  getDefinitionQueryResultForDefinitionNode: () => getDefinitionQueryResultForDefinitionNode,
  getDefinitionQueryResultForField: () => getDefinitionQueryResultForField,
  ...
  getOperationASTFacts: () => getOperationASTFacts,
  getOperationFacts: () => getOperationFacts,
  getOutline: () => getOutline,
  getQueryFacts: () => getQueryFacts,
  getRange: () => getRange2,
  getTokenAtPosition: () => getTokenAtPosition,
  getTypeInfo: () => getTypeInfo,
  getVariableCompletions: () => getVariableCompletions,
  getVariablesJSONSchema: () => getVariablesJSONSchema,
  isIgnored: () => isIgnored,
  list: () => list,
...
//# sourceMappingURL=chunk-OK4MC34Q.js.map
