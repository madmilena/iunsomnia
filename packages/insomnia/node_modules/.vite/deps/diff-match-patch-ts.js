...
// ../../node_modules/diff-match-patch-ts/diff-match-patch-ts.mjs
var DiffOp;
(function(DiffOp2) {
  DiffOp2[DiffOp2["Delete"] = -1] = "Delete";
  DiffOp2[DiffOp2["Equal"] = 0] = "Equal";
  DiffOp2[DiffOp2["Insert"] = 1] = "Insert";
})(DiffOp || (DiffOp = {}));
...
var DiffMatchPatch = class {
  ...
  diff_cleanupMerge(diffs) {
        ...
        case DiffOp.Equal:
          if (count_delete + count_insert > 1) {
            if (count_delete !== 0 && count_insert !== 0) {
              ...
              if (commonlength !== 0) {
                if (pointer - count_delete - count_insert > 0 && diffs[pointer - count_delete - count_insert - 1][0] === DiffOp.Equal) {
    ...
    while (pointer < diffs.length - 1) {
      if (diffs[pointer - 1][0] === DiffOp.Equal && diffs[pointer + 1][0] === DiffOp.Equal) {
  ...
  diff_linesToCharsMunge_(text, lineArray, lineHash) {
    ...
    while (lineEnd < text.length - 1) {
      ...
      lineStart = lineEnd + 1;
      if (Object.prototype.hasOwnProperty.call(lineHash, line) || lineHash[line] !== void 0) {
      ...
      while (bigpatch.diffs.length !== 0) {
        ...
        while (bigpatch.diffs.length !== 0 && patch.length1 < patch_size - this.Patch_Margin) {
          ...
          if (diff_type === DiffOp.Insert) {
            ...
            empty = false;
          } else if (diff_type === DiffOp.Delete && patch.diffs.length === 1 && patch.diffs[0][0] === DiffOp.Equal && diff_text.length > 2 * patch_size) {
            patch.length1 += diff_text.length;
        ...
        if (postcontext !== "") {
          ...
          if (patch.diffs.length !== 0 && patch.diffs[patch.diffs.length - 1][0] === DiffOp.Equal) {
...
//# sourceMappingURL=diff-match-patch-ts.js.map
