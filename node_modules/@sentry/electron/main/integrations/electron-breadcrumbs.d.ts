 ...
 */
export declare const electronBreadcrumbsIntegration: (userOptions?: Partial<ElectronBreadcrumbsOptions<EventTypes>> | undefined) => import("@sentry/core").Integration;
export {};
